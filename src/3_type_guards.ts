...
// keyof guards
type parmstype=string|number

function add(parms1:parmstype,parms2:parmstype):parmstype{
...
// in guards ******Node::: in guards kaj kore object a sathe******
...
function getusercheck(user:normalusertype|adminusertype):string{
    if('role' in user){
...
const nomarlnuser1:normalusertype={name:'Mr.boss'}
const adminuser1:adminusertype={name:'Mr.ali',role:"admin"}
...
class Animal{
    name:string;
    spceies:string
    constructor(name:string,spceies:string){
        this.name=name
